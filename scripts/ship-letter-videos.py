...
PACKS: dict[str, list[dict]] = {
    ...
    "S": [
        {"slug": "sun", "word": "Sun", "sentence": "The sun rises.",
         "still": "Classic cartoon sun with triangular rays, eyes and smile, rising over hills. Not a blank yellow ball.",
         "motion": "The sun RISES. Rays stay. Camera locked. Simple kids animation, no morphing."},
    ...
    "V": [
        ...
        {"slug": "volcano", "word": "Volcano", "sentence": "The volcano puffs smoke.",
         "still": "Classic cone volcano with crater and a puff of smoke. Not a lump. Not scary.",
         "motion": "The volcano PUFFS smoke. Stays a volcano. Camera locked. Simple kids animation, no morphing."},
        {"slug": "van", "word": "Van", "sentence": "Vin's van jumps.",
         "still": "Yellow cartoon minivan jumping over a bump. Four wheels, windows. No face.",
         "motion": "The van JUMPS over bumps and travels. Stays a van. Simple kids animation, no morphing."},
