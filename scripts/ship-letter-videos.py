...
PACKS: dict[str, list[dict]] = {
    "L": [
        ...
        {"slug": "leaf", "word": "Leaf", "sentence": "The leaf twirls.",
         "still": "A single green leaf twirling in the air, forest bokeh.",
         "motion": "The leaf TWIRLS in the air the entire time. Camera locked. Simple kids animation, no morphing."},
        ...
        {"slug": "lollipop", "word": "Lollipop", "sentence": "Lily unwraps a lollipop.",
         "still": "Cartoon girl about 5 unwrapping a swirl lollipop. Candy is food, no face. Wrapper half on.",
         "motion": "The girl UNWRAPS the lollipop. Candy has no face. Camera locked. Simple kids animation, no morphing."},
    ...
    "M": [
        ...
        {"slug": "monkey", "word": "Monkey", "sentence": "The monkey hangs by its tail.",
         "still": "Cute cartoon monkey hanging from a jungle branch by its tail, waving. Friendly.",
         "motion": "The monkey HANGS by its tail and swings a little. Camera locked. Simple kids animation, no morphing."},
    ...
    "N": [
        ...
        {"slug": "noodle", "word": "Noodle", "sentence": "Nina slurps noodles.",
