...
**v0.485** Big T clip 1 redone again. Clips 2-4 locked to the same olive T.

**v0.484** Little d clip 1 redone with black dot eyes. Clips 2-4 locked to that face.

**v0.483** Little c clips 2, 3, and 4 redone again. Clip 1 stays.
...
**v0.477** Little b clip 3 redone. Only the boat talks. Clip 4 redone so it still connects.

**v0.476** Big Y clip 4 redone. Only the yak talks. Clip 3 stays.

**v0.475** Big Y clip 3 confirmed and saved. Clip 4 is still waiting.

**v0.474** Big T clip 2 redone. Clips 3 and 4 redone so they still connect. Clip 1 stays.
...
**v0.470** Big T clip 1 confirmed and saved. Clips 2–4 are still the orange T.
