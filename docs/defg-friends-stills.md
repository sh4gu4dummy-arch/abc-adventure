# D–G Friends stills (QA, no I2V)

One confirmed still per case. I2I from Meet + `public/posters/`.
No film until PASS + go.

| Case | Friends | Place | Path |
|---|---|---|---|
| Big D | dog duck dinosaur | pond park | `docs/audit/d-play-1/00-source-still.jpg` |
| little d | donut drum door | hallway / door | `docs/audit/d-little-play-1/00-source-still.jpg` |
| Big E | elephant earth eagle | cliff / sky | `docs/audit/e-play-1/00-source-still.jpg` |
| little e | egg elbow elf | kitchen | `docs/audit/e-little-play-1/00-source-still.jpg` |
