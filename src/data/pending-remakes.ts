...
export const PENDING_REMAKES: PendingRemake[] = [
  ...
  },
  {
    ...
    since: "v0.441",
    notes: "Clip 4 redone from the new clip 3 ending. The yak says I'm Yak. Y's mouth stays painted shut. One yo-yo by the tree. Not confirmed.",
  },
  {
    id: "big-z-friends",
    ...
    since: "v0.443",
    notes: "Clip 4 redone. The sweater is gone. The zebra stays shut. The zipper says I'm Zipper. Clip 3 still has the sweater, so that cut jumps. Not confirmed.",
  },
];
