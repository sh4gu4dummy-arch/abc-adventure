...
const STORY_BEATS: Record<string, StoryBeat[]> = {
  ...
  U: [
    {
      text: "A unicorn dropped a ukulele under the chair.",
      action: "find",
      scene: "home",
      cast: ["unicorn", "ukulele", "under"],
    },
    {
      text: "The unicorn picked the ukulele up and played it.",
      action: "dance",
      scene: "home",
      cast: ["unicorn", "ukulele", "up"],
    },
    {
      text: "The unicorn gave the ukulele to a kid in a uniform.",
      action: "share",
      scene: "home",
      cast: ["unicorn", "ukulele", "uniform"],
    },
  ],
  V: [
    {
      text: "A vulture put on a vest.",
      action: "wave",
      scene: "home",
      cast: ["vulture", "vest"],
    },
    {
      text: "The vulture vacuumed.",
      action: "zoom",
      scene: "home",
      cast: ["vulture", "vacuum"],
    },
    {
      text: "The vulture got in the van.",
      action: "zoom",
      scene: "home",
      cast: ["vulture", "van"],
    },
  ...
  W: [
    {
      text: "A worm found a wagon.",
      action: "find",
      scene: "garden",
      cast: ["worm", "wagon"],
    },
    {
      text: "The worm poured water in the wagon.",
      action: "splash",
      scene: "garden",
      cast: ["worm", "water", "wagon"],
    },
    {
      text: "The worm washed a window.",
      action: "wave",
      scene: "home",
      cast: ["worm", "window"],
    },
  ...
  X: [
    {
      text: "A fox found a box.",
      action: "find",
      scene: "home",
      cast: ["fox-x", "box"],
    },
    {
      text: "The fox pulled a xylophone from the box.",
      action: "find",
      scene: "home",
      cast: ["fox-x", "xylophone", "box"],
    },
    {
      text: "The fox played the xylophone.",
      action: "dance",
      scene: "home",
      cast: ["fox-x", "xylophone"],
    },
  ],
  Y: [
    {
