...
const STORY_BEATS: Record<string, StoryBeat[]> = {
  ...
  E: [
    {
      text: "An elephant found a golden egg.",
      action: "find",
      scene: "garden",
      cast: ["elephant", "egg"],
    },
  ...
  F: [
    {
      text: "A fox and a frog watched a fish splash.",
      action: "splash",
      scene: "ocean",
      cast: ["fox", "frog", "fish"],
    },
    {
      text: "A flower bloomed as a firetruck zoomed by, and a fairy winked.",
      action: "zoom",
      scene: "garden",
      cast: ["flower", "firetruck", "fairy"],
    },
    {
      text: "Fantastic fun!",
      action: "celebrate",
      scene: "party",
      cast: ["fish", "frog", "flower", "firetruck", "fox", "fairy"],
    },
  ],
  G: [
    {
