...
import { initCaseMode } from "@/lib/case-mode";
import {
  isEmbeddedPreview,
  isGrokSandboxHost,
...
try{var ck='abc-case-mode-v1';document.documentElement.dataset.case=localStorage.getItem(ck)==='lower'?'lower':'upper';}catch(e6){}
