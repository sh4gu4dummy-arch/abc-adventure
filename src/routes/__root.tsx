      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var k='abc-layout-pref-v1';var p=localStorage.getItem(k)||'auto';var w=window.innerWidth;var r=p==='phone'?'phone':p==='desktop'?'desktop':(w>=768?'desktop':'phone');var h=document.documentElement;h.dataset.layout=r;h.dataset.layoutPref=p;h.classList.add(r==='phone'?'layout-phone':'layout-desktop');}catch(e){}
